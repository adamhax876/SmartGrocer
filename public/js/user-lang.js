const userTranslations = {
    en: {
        ...
        logo_hint: "Appears on invoices and reports. Recommended: 300x300px (PNG/JPG). (Max Size: 2MB)",
    ...
    ar: {
        ...
        logo_hint: "يظهر الشعار في الفواتير والتقارير. المقاس الموصى به: 300x300 بكسل. (أقصى حجم: 2 ميجابايت)",
